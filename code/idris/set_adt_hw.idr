...
set_cardinality: (eq a) => (s: set a) -> nat
...
list_remove v (h::t) = ite (member v (h::t))
                           (list_remove v t)
                           (h::t)
...
set_member v (mkSet l) = ite (member v l)
                             true
                             false
...
list_combine (h::t) l = ite (member h l)
                            (list_combine t l)
                            (h::(list_combine t l))
...
list_option:(eq a) =>  list a -> option a
list_option nil = none
list_option (h::t) = some h

list_witness: (eq a) => (p: a -> bool) -> list a -> option a
list_witness p l = ite (set_exists p (mkSet (filter p l)))
                       (list_option (filter p l))
                       none
...
same_elements l1 l2 = and (subset_elements l1 l2)
